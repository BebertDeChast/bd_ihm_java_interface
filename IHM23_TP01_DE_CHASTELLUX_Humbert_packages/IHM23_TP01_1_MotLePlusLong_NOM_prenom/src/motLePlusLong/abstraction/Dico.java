...
public class Dico {
	...
	/**
	 * @param tirage, un mot
	 * @return retourne un tableau d'Object constitue de tous les mots realisable a
	 *         partir du mot tirage
	 */
	 ...
	 * @param mot,       une chaine de caractere contenant au moins une occurrence
	 *                   de "caractere"
	 * @return retourne le mot que l'on obtient en supprimant la premiere occurrence
	 *         de caractere dans le mot mot.
	 */
	 ...
	 * @return retourne true si et seulement si il est possible de realiser le mot
	 *         mot a partir des lettres de tirage.
	 */
